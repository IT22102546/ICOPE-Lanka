...
const checkResponse = await fetch(`${API}/api/v1/auth/check-account`, {
  method: "POST",
  headers: {
    "Content-Type": "application/json",
  },
  body: JSON.stringify({
    identifier: emailOrPhone.trim(), // ✅ Using "identifier"
  }),
});
      ...
      // In handleVerify function, update the OTP request:
const otpResponse = await fetch(
  `${API}/api/v1/auth/send-password-reset-otp`,
  {
    ...
    body: JSON.stringify({
      identifier: emailOrPhone.trim(), // ✅ Also using "identifier"
