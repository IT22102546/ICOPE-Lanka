// app/(auth)/onBoard3.tsx - ICOPE Lanka Onboarding Screen 3
          ...
          <Animated.View style={[styles.contentWrapper, contentTransform]}>
            ...
            <View style={styles.textContainer}>
              ...
              <MaskedView
                ...
                maskElement={
                  <View style={styles.maskElement}>
                    <Text style={styles.gradientTitleMask}>Connected Care Team</Text>
                  </View>
                }
              >
                <LinearGradient
              ...
              <Text style={styles.description}>
                Collaborate with physiotherapists and healthcare professionals to provide integrated elderly care.
              </Text>
